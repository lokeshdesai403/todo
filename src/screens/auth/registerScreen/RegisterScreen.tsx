...
export default function RegisterScreen(_props: any) {
  ...
  const doRegister = () => {
    auth()
      .createUserWithEmailAndPassword(textUserEmail, textUserPassword)
      .then((response: any) => {
          ...
          <View style={styles.viewBottomRegister}>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
              <TouchableOpacity style={{ flex: 1 }} onPress={() => {
                _props.navigation.navigate(Constants.LOGIN_SCREEN)
              }}>
                <View>
                  <Text style={styles.textRegisterStyleClick}>{'Login'}</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
